...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= __BASEURL__; ?>/iCheck/square/blue.css">
...
<!-- jQuery 3 -->
<script src="<?= __BASEURL__; ?>/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?= __BASEURL__; ?>/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="<?= __BASEURL__; ?>/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
