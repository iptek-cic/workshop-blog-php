...
if (isset($_POST['create'])) {
    ...
    if ($query) {
        echo "<script>
            alert('Tambah data author baru berhasil');
            window.location= '?page=author';
        </script>";
    } else {
        echo "<script>
            alert('Tambah data author baru gagal');
        </script>";
    }
}
        ...
        <div class="col-lg-12 col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Tambah author Baru</h3>
                </div>
                <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            ?>
                                <select class='form-control' name="role" required>
                                    <option>-- Pilih Hak Akses author --</option>
